...
function MorphingDialogTrigger({
  ...
  return (
    <motion.div
      ...
      className={cn('relative', disabled ? 'cursor-default' : 'cursor-pointer', className)}
      onClick={handleClick}
...
function MorphingDialogContent({
  ...
  return (
    <motion.div
      ref={containerRef}
      layoutId={`dialog-${uniqueId}`}
      className={cn('max-h-[calc(100dvh-1rem)] max-w-[calc(100vw-1rem)] overflow-hidden', className)}
      style={style}
      role='dialog'
      aria-modal='true'
