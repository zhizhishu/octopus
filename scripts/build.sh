...
readonly GIT_AUTHOR="${GIT_AUTHOR:-zhizhishu}"
readonly GIT_REPO="${GIT_REPO:-https://github.com/zhizhishu/octopus}"
readonly GIT_VERSION="${GIT_VERSION:-future-${COMMIT_ID}}"
...
build_frontend() {
    ...
    if ! NEXT_PUBLIC_APP_VERSION="$GIT_VERSION" NEXT_PUBLIC_GITHUB_REPO="$GIT_REPO" pnpm run build; then
